...
:DeviceBarrierValidINTEL_token: 6186
...
+
--
*RESOLVED*: Yes, see the internal Khronos SPIR-V issue 746.
...
|B|2023-08-11|Ben Ashbaugh|Added *{DeviceBarrierValidINTEL}* *BuiltIn*.
|C|2025-01-13|Ben Ashbaugh|Assigned enums.
|========================================
